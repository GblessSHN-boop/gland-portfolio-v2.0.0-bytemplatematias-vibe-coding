"""ensure_highlights_schema for GLAND selected highlights table."""
...
def get_existing_columns(cursor):
    cursor.execute(
        ...
        WHERE TABLE_SCHEMA = %s
          AND TABLE_NAME = 'selected_highlights'
        """,
        (config.DB_NAME,),
    )
...
def main():
    ...
    try:
        ...
        cursor.execute(HIGHLIGHTS_TABLE_SQL)
        ...
        for column_name, column_definition in REQUIRED_COLUMNS.items():
            ...
            cursor.execute(
                f"ALTER TABLE selected_highlights "
        ...
        print("Highlights schema ensured successfully.")
